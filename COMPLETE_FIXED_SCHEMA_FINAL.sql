-- ============================================
-- COMPLETE SUPABASE SCHEMA - FINAL FIX
...
-- ============================================
-- BOOKING SLOTS TABLE POLICIES
-- ============================================
CREATE POLICY "booking_slots_select_by_agent" ON booking_slots 
  FOR SELECT 
  USING (
...
BEGIN
  ...
  RAISE NOTICE '   - bookings, booking_slots, conversations, messages';
  RAISE NOTICE '   - notifications, wishlists, banners, homepage_sections';
  RAISE NOTICE '   - staff, managed_properties';
  RAISE NOTICE '';
